        ...
        <section className="relative px-6 py-20 sm:px-20">
            <div className="flex flex-col  gap-y-10 items-center">
                ...
                <div className="relative grid w-full grid-cols-1 gap-10 md:mt-20 md:grid-cols-2">
                    <div className="flex   flex-col gap-y-6 rounded-2xl bg-white xl:px-20 p-10 ">
                        ...
                        <div className="mt-auto flex justify-center">
                            <img src="lock.webp" alt="nothinhg" className=" h-[300px] rounded-2xl lg:h-[400px] w-full object-cover" />
                        </div>
                    </div>
                    <div className="flex   flex-col gap-y-6 rounded-2xl bg-white xl:px-20 p-10">
                        ...
                        <div className="mt-auto flex justify-center ">
                            <img src="treadmill.webp" alt="nothinhg" className=" h-[300px] rounded-2xl lg:h-[400px] w-full object-cover" />
                        </div>
                    </div>
                    ...
                    <div className=" flex  flex-col gap-y-6 rounded-2xl bg-white xl:px-20 p-10 ">
                        ...
                        <div className="mt-auto flex justify-center">
                            <img src="elevator.webp" alt="nothinhg" className=" h-[300px] rounded-2xl lg:h-[400px] w-full object-cover" />
                        </div>
                    </div>
                    <div className=" flex  flex-col gap-y-6 rounded-2xl bg-white xl:px-20 p-10 ">
                        ...
                        <div className="mt-auto flex justify-center">
                            <img src="face.webp" alt="nothinhg" className=" h-[300px] rounded-2xl lg:h-[400px] w-full object-cover" />
                        </div>
                    </div>
                </div>
            </div>
