    ...
    return (
        ...
        >
            ...
            <div className=" grid lg:grid-cols-2 ">
                ...
                >
                    <h2 className="text-4xl  font-bold sm:text-5xl lg:text-6xl  2xl:text-7xl text-center ">Bạn có biết</h2>
                ...
                <div className="absolute left-0 top-20 flex  w-full   justify-center   opacity-60  sm:items-center lg:relative">
                    <Reveal scale={0.7}>
                        <img src="/hand-orange.webp" alt="about" className="-left-10 h-[75vh] sm:opacity-100 opacity-50  object-cover  " />
                    </Reveal>
                </div>
            </div>
        </section>
