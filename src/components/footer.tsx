...
export default function Footer() {
  return (
    <footer className="z-50 bg-black text-white">
      {/* mt-20 mb-5 sm:my-10  */}
      <div className="container grid md:grid-cols-4 grid-cols-1 sm:grid-cols-2 gap-y-10  py-10 pb-20">
        ...
        <div className="w-full flex flex-col items-start">
          ...
          <div className="space-y-2 flex flex-col   gap-[15px] sm:gap-0">
            <span className="w-full text-base flex  gap-[10px] flex-row items-start">
              <MapPinIcon className="min-w-[30px] text-[20px]" />
              <p className="text-justify">
                Tầng 3, Showtime D12 Giảng Võ, Quận Ba Đình, Việt Nam
              </p>
            </span>
            <span className="w-full text-base flex  gap-[10px] flex-row items-center">
